...
doc.out("от МБУ ЦСДБ ГО г. Уфа", "A3")
...
if(zaktype == 1)
{
  doc.out("ЗАКАЗЧИК: МБУ ЦСДБ ГО г. Уфа", "A6")
  doc.out("АДРЕС ДОСТАВКИ: 450077 г. Уфа, ул. Мингажева, 109", "A7")
  'doc.out("Фундаментальная библиотека СПбГТУ.", "A8")
  doc.out("Тел./факс: 276-61-96; 276-61-95", "A9")
}
else
{
 if(zaktype == 0)
