define function main()
{
 ...
 doc.out("Литература,поступившая по данному документу,", "C10")
 doc.out("  принята и записана в инвентари следующих", "C11")
 doc.out("    отделов Фундаментальной библиотеки", "C12")
 doc.out("Сиглы", "A14")
 doc.out("Инвентарные номера", "B14")
 doc.out("Кол-во", "G14")
 doc.out("Сумма", "H14")
